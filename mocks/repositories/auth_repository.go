...
//
//	mockgen -source=repositories.go -destination=../../mocks/repositories/auth_repository.go -package=mockrepositories -exclude_interfaces=UsersRepository,MessagesRepository,ChatsRepository,WebSocketsRepository
//
