...
Модальное окно создания нового чата. Позволяет выбрать тип (приватный/групповой), ввести название и описание (для группового), найти и выбрать участников. Аватары пользователей отображаются как `<img>` (при наличии `avatarPath`) с fallback на инициал.
