...
//	loadingMore  bool
//	// Убираем pendingMessages - больше не нужны
//}
//
...
//	// (ID будет 0, но это нормально для UI)
//	localMsg := Message{
//		ID:        uint64(time.Now().UnixNano()), // Временный ID для уникальности
...
//	}
//
//	// Сразу добавляем в историю сообщений
//	messagesMu.Lock()
...
//
//	// Отправляем через WebSocket (асинхронно, не ждем ответа)
//	go func() {
//		err := sendWSMessage(cw.currentChat.ID, text)
//		if err != nil {
//			// Если ошибка - показываем уведомление, но сообщение уже в истории
//			fyne.Do(func() {
